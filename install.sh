...
install_hive() {
	...
	wget --no-check-certificate https://ai-platform-package.gz.bcebos.com/bigdata/apache-hive-1.2.0-bin.tar.gz
	tar -xf apache-hive-1.2.0-bin.tar.gz -C /opt
	ln -s /opt/apache-hive-1.2.0-bin /opt/hive
